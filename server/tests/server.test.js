...
describe('PATCH /todos/:id',()=>{
  ...
  it('shouldn\'t update the todo', (done)=>{
    var id = todos[0]._id.toHexString();
    var text = "This should be the new text";
    request(app)
    .patch(`/todos/${id}`)
...
describe('POST /users',()=>{
  it('should create a user',(done)=>{
    var email = "example@example123.com";
    var password = "123mnb!";
  ...
  it('should return validation errors if request invalid',(done)=>{
    var email = "Samuel.cote.example.com";
    var password = "123";
...
describe('POST /users/login',()=>{
  it('should login user and return aut toke',(done)=>{
    request(app)
      .post('/users/login')
      .send({
        email:users[1].email,
